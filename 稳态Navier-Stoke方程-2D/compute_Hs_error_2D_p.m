function error=compute_Hs_error_2D_p(P,T,Tb_trial,s,solution_vector,analytical_solution,NLB,basis_type,Gauss_point_reference_triangle,Gauss_coefficient_reference_triangle)
%%%s是导数阶
%%%solution_vec：数值解向量
